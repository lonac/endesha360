    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/api/schools/register").authenticated()  // Temporarily allow any authenticated user
                .requestMatchers("/api/schools/admin/**").hasRole("ADMIN")  // Admin endpoints
                .requestMatchers("/api/schools/my-school").authenticated()  // Temporarily allow any authenticated user
